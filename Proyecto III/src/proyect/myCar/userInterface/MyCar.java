...
public class MyCar implements IConstants, IObserver
{
	...
	private void initialize() {
		...
		label.setIcon(new ImageIcon("C:\\Users\\dnnxl\\Downloads\\Imagenes Poo MyCar\\Prototipo 1.png"));
		label.setBounds(28, 395, 660, 153);
		frmMyCar.getContentPane().add(label);
		
		JButton button = new JButton("");
		button.setIcon(new ImageIcon("C:\\Users\\dnnxl\\Downloads\\herramientas-y-utensilios.png"));
		button.setBackground(new Color(0, 206, 209));
		button.setBounds(98, 651, 38, 37);
		frmMyCar.getContentPane().add(button);
		
		JButton button_1 = new JButton("");
		button_1.setIcon(new ImageIcon("C:\\Users\\dnnxl\\Downloads\\herramientas-y-utensilios (1).png"));
		button_1.setBackground(new Color(0, 206, 209));
		button_1.setBounds(524, 651, 38, 37);
